...
final class TelegramPickerViewController: UIViewController {
    ...
    func checkStatus(completionHandler: @escaping ([PHAsset]) -> ()) {
        ...
        case .denied, .restricted:
            ...
            let alert = UIAlertController.init(title:  "Permission denied", message: "\(productName) does not have access to contacts. Please, allow the application to access to your photo library.", preferredStyle: .alert)
            //(title: "Permission denied", message: "\(productName) does not have access to contacts. Please, allow the application to access to your photo library.", preferredStyle: .alert)
    ...
    func fetchPhotos(completionHandler: @escaping ([PHAsset]) -> ()) {
        Assets.fetch { [unowned self] result in
            ...
            case .error(let error):
                ...
                //(style: .alert, title: "Error", message: error.localizedDescription)
