...
final class ContactsPickerViewController: UIViewController {
    ...
    func checkStatus(completionHandler: @escaping ([String: [CNContact]]) -> ()) {
        ...
        case .denied, .restricted:
            ...
            let alert = UIAlertController.init(title: "Permission denied", message: "\(productName) does not have access to contacts. Please, allow the application to access to your contacts.", preferredStyle: .alert)
                //UIAlertController(style: .alert, title: "Permission denied", message: "\(productName) does not have access to contacts. Please, allow the application to access to your contacts.")
        ...
        Contacts.fetchContactsGroupedByAlphabets { [unowned self] result in
            ...
            case .error(let error):
                ...
                let alert = UIAlertController.init(title: "Error", message: error.localizedDescription, preferredStyle: .alert)
                    //UIAlertController(style: .alert, title: "Error", message: error.localizedDescription)
